...
export default {
  ...
  data() {
    ...
    var CarouselImage = [
      ...
      "https://wi.wallpapertip.com/wsimgs/80-802123_fashion-clothing-background-hd.jpg",
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyAjXgv7-Y8XdZzzHS9v611KxnlX7PDtD2_w&usqp=CAU"
    ];
