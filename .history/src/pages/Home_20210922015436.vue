<template>
  ...
  <div id="goal-main-container">
    ...
    <div id="goal-image-container" :style="{
...
export default {
  ...
  methods: {
    InitData(){
      this.Model = {
        ...
        GoalImageURL: '/assets/image/goal-image.png'
      };
    },
  ...
  computed: {
    GetGoalImage: function () {
      return {
        backgroundImage: "url(https://i.pinimg.com/originals/f9/93/0d/f9930d92d39fa7bec0a63b739bbbfe64.png)",
        backgroundPosition: "center center",
        backgroundSize: "cover",
      }
    }
