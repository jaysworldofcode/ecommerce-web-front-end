...
<style scoped>
  ...
  #goal-main-container {
    ...
    background-image: linear-gradient(155deg, rgba(219,219,219,0.29735644257703087) 25%, rgba(179,179,191,0.27494747899159666) 35%, rgba(150,148,180,0.2777485994397759) 48%, rgba(47,124,140,0.26094187675070024) 100%), url(../assets/image/donating.jpg);
