    ...
    <el-carousel height="70vh">
      <el-carousel-item v-for="item in Model.CarouselImageURL" :key="item">
        <div :style="GetCarouselBackgroundImageCSS(item)" id="carousel-content-container">
            ...
            <p class="carousel-content"><span class="bold">"</span>Fashion is part of the daily air and it changes all the time, with all the events. You can even see the approaching of a revolution in clothes. You can see and feel everything in clothes.<span class="bold">"</span></p>
