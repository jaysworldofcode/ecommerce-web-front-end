<template>
  <div class="home-container">
    ...
    <el-row class="go-to-product center-content">
      <el-button icon="el-icon-goods" type="primary" @click="GoToProducts()" round>See All Product</el-button>
    </el-row>
    <div id="message-v1">
    ...
    <el-row class="go-to-product center-content">
      <button icon="el-icon-goods" class="custom-button-primary"><i class="fa fa-shopping-cart"></i>View All Product</button>
    </el-row>
  <div id="message-v2">
