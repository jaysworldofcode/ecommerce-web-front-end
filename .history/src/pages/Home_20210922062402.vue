<template>
    ...
    <el-carousel height="70vh">
      <el-carousel-item v-for="item in Model.CarouselImageURL" :key="item">
        <div :style="GetCarouselBackgroundImageCSS(item)" id="carousel-content-container">
            <p class="carousel-content-title">LOREM IPSUM DOLOR</p>
            <p class="carousel-content"><span class="bold">"</span>Fashion is part of the daily air and it changes all the time, with all the events. You can even see the approaching of a revolution in clothes. You can see and feel everything in clothes."</p>
            <button class="custom-button-plain">AUT UNDE</button>
        </div>
      </el-carousel-item>
    </el-carousel>
  ...
  <div id="branch-container">
    ...
    <img src="../assets/image/map-branch.jpg" style="height: 40px; width: 40px">
  </div>
  </div>
</template>
<script lang='ts'>
