...
<style scoped>
  ...
  #goal-main-container {
    ...
    background-image: linear-gradient(155deg, rgba(219,219,219,0.5074404761904762) 25%, rgba(179,179,191,0.4990371148459384) 35%, rgba(150,148,180,0.5382528011204482) 48%, rgba(47,124,140,0.5634628851540616) 100%), url(../assets/image/donating.jpg);
