...
<style scoped>
  ...
  #goal-main-container {
    ...
    background-image: linear-gradient(155deg, rgba(219,219,219,1) 25%, rgba(179,179,191,1) 35%, rgba(150,148,180,1) 48%, rgba(47,124,140,1) 100%), url(../assets/image/donating.jpg);
