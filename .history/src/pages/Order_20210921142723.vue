        ...
        <div v-if="Model != null" id="product-data-container">
            ...
            <div id="info-button-actions-container">
                ...
                <div id="colors-sample">
                    <div v-for="item in Model.Color" :key="item" :style="{ height: '20px', width: '20px', backgroundColor: item }" class="selected-color">
                    </div>
                </div>
...
export default defineComponent({
  ...
  async created(){
    ...
    this.Model = await new ProductService().GetProductById(urlParams.get('id'));
  },
  data() {
      return {
          Model: null,
